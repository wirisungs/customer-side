        ...
        <View style={styles.container}>
          <View style={styles.all}>
            <View style={styles.all1}>
              ...
              <TouchableOpacity style={styles.more} onPress={() => navigation.goBack()}>
          ...
          <View style={styles.all}>
            ...
            <View style={styles.box2}>
              ...
              <View style={styles.status1}>
                <Text style={styles.textstatus}>Thris Potato - 092032xxxxx</Text>
                <Text style={styles.textstatus1}>32/21/2 Nguyễn Thị Minh Khai</Text>
                <Text style={styles.textstatus}>Thris Potato - 092032xxxxx</Text>
                <Text style={styles.textstatus1}>32/21/2 Nguyễn Thị Minh Khai</Text>
              </View>
            </View>
          ...
          <View style={styles.centeredView}>
            <View style={styles.modalView}>
              <View style={styles.boxcancel}>
                <Image source={ImagesAssets.boxcancel} style={styles.imgDH} resizeMode='contain' />
