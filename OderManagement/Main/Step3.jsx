            ...
            <View style={styles.container}>
                <View>
                    ...
                    <Text style={styles.text2}>
                        ...
                        Nếu nhập sai thông tin sẽ ảnh hưởng đến quá trình xử lý đơn hàng và chúng tôi sẽ
                ...
                <TouchableOpacity onPress={() => navigation.navigate('CreateStep2')} style={styles.btnContainer}>
