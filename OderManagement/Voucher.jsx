    ...
    <View style={styles.container}>
        ...
        <View style={styles.content}>
           ...
           <View style={styles.box1}>
             <Text style={styles.text2}>Chú ý: Mã giảm giá chỉ được cấp tại</Text>
           ...
           {Promo_EV.map((item, index) => (
               ...
               <View style={styles.boxMain1}> 
                     <Image
                        source={ImagesAssets.promo}
                        style={styles.imgpromo}
                     /> 
               </View>
               <View style={styles.boxMain2}>
                  <Text style={styles.textdiss} numberOfLines={1} ellipsizeMode="tail">{item.name}</Text>
